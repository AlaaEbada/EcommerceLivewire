...
@include('livewire.admin.auth.authHead')
...
<body class="light ">
        ...
        <div class="row align-items-center h-100">
            ...
            <form class="col-lg-3 col-md-4 col-10 mx-auto text-center" action="{{ route('admin.login') }}" method="POST">
                ...
                <div class="checkbox mb-3">
                    <label>
                        <input type="checkbox" id="remember-check" name="remember"> {{ __('Remember me') }}
                    </label>
                </div>
                ...
                {{-- Copyright --}}
                <p class="mt-5 mb-3 text-muted">@include('livewire.admin.partials.copyright')</p>
    ...
    @include('livewire.admin.auth.authScripts')
</body>
